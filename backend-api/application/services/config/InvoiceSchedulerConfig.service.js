...
class InvoiceSchedulerConfigService {
    ...
    async InsertInvoiceSchedularConfigService(date, time, acceptance_time_period) {
        return await this.invoiceSchedulerConfigDatabase.InsertInvoiceSchedularConfigDatabase(
            date,
            time,
    ...
    async UpdateInvoiceSchedularConfigService(id, date, time, acceptance_time_period, is_active) {
        return await this.invoiceSchedulerConfigDatabase.UpdateInvoiceSchedularConfigDatabase(
            id,
            date,
            time,
            acceptance_time_period,
