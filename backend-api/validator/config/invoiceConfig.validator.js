...
const invoiceTemplateGenerationValidator = [
    ...
    body("company_header_config.company_name")
        .isString()
        .notEmpty()
    ...
    body("company_header_config.email_address")
        .isEmail()
        .withMessage("Invalid email_address")
        .optional(),
    body("company_header_config.gstin_number").isString().optional(),

    // === invoice_info_config ===
    body("invoice_info_config.invoice_title")
        .isString()
        .notEmpty()
    ...
    body("lead_table_preview_config")
        .isArray()
        .withMessage("lead_table_preview_config must be an array"),
    // body("lead_table_preview_config.*.table_name").isString().notEmpty().withMessage("table_name is required"),
    body("lead_table_preview_config.*.column_name")
        .isString()
        .notEmpty()
        .withMessage("column_name is required"),
