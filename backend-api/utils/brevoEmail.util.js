...
const { brevoEmailConfig } = require("../configs/brevoEmail.config");

const apiInstance = new brevo.TransactionalEmailsApi();
const apiKey = apiInstance.authentications["apiKey"];
apiKey.apiKey = brevoEmailConfig.apiKey;
/**
 ...
 */
function sendBrevoEmail(subject, htmlContent, toArray, attachments = []) {
    return new Promise((resolve, reject) => {
        const sendSmtpEmail = new brevo.SendSmtpEmail();
        sendSmtpEmail.subject = subject;
        sendSmtpEmail.htmlContent = htmlContent;
        sendSmtpEmail.sender = {
            name: brevoEmailConfig.senderName,
            email: brevoEmailConfig.senderEmail,
        };
        ...
        apiInstance.sendTransacEmail(sendSmtpEmail).then(
            ...
            function (error) {
                console.error("Brevo Email API call failed.", error);
                reject(error);
            },
        );
    });
